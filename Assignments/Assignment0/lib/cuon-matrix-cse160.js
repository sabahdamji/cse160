...
class Vector3 {
    ...
    //Recieved help from chatGPT for this function 
...
//Recieved help from chat gpt on this function
angleBetween(other) {
  const d = Vector3.dot(this, other);
  const m = this.magnitude() * other.magnitude();
  const r = Math.acos(d / m);
...
//Recieved help from Chat GPT for this function 
